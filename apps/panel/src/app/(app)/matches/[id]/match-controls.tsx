...
import { listBackupsAction, matchAction, type MatchActionState } from '../actions';
...
const STATE_HINT: Record<string, string> = {
  ...
  LIVE: 'Match is live. The score comes from the server, not from PMatch counting rounds.',
...
export function MatchControls({
  ...
  return (
    <div className="space-y-4">
      ...
      {canAdmin && match.state !== 'DRAFT' && match.state !== 'CANCELLED' ? (
      ...
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-0.5 text-xs text-ink-400">
            Restoring needs sv_cheats for a moment; PMatch turns it back off
            immediately and leaves the match paused.
          </p>
        </div>
        <button
          type="button"
